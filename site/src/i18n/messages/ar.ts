...
export const ar: DeepPartial<Messages> = {
  ...
  // -- 404 ---------------------------------------------------------------
  notFound: {
    para: 'حسنًا، هذا محرج بعض الشيء. لأننا نرفض تتبّع زوّارنا أو استخدام ملفّات الارتباط، لا فكرة لدينا البتّة عن كيفية وصولك إلى هنا. لكن يمكننا أن نؤكّد أن هذه الصفحة غير موجودة.',
    homeCta: 'خذني إلى الرئيسية',
    imageAlt: 'ممرّ في حديقة تغمره الشمس ينفتح أمامك في يوم مشرق ومنفتح',
  },

  // -- Privacy -----------------------------------------------------------
  privacy: {
    title: 'الخصوصية، بكل بساطة.',
    lede: 'بلا تتبّع، بلا ملفّات ارتباط، بلا حسابات، بلا لفٍّ ولا دوران. إليك بالضبط ما يحدث لبياناتك، بلغة بشرية واضحة. باختصار: صمّمنا هذا الموقع كي لا تكون هناك بيانات تقريبًا.',

    linkedTitle: 'بيانات مرتبطة بك',
    linkedBody: 'لا شيء. لا حسابات، لا تسجيلات، لا نشرات بريدية، ولا نماذج تواصل تسأل عن اسمك. يمكنك قراءة كل كتاب، وتنزيل كل صيغة، واستخدام الموقع كلّه دون أن تخبرنا من أنت.',

    typeTitle: 'ما تكتبه',
    typeBody: 'صندوق البحث يعمل في متصفّحك. حين ترسل إلينا ملاحظة، أو تطلب كتابًا، أو تشارك تجربة، فإن الكلمات التي تكتبها هي كل ما نستلمه: بلا اسم، بلا بريد، بلا عنوان، ولا شيء مرفق. أرجو ألّا تضع تفاصيل شخصية في النصّ نفسه؛ وإن رصدنا أيًّا منها أثناء المراجعة، أزلناها قبل نشر أيّ شيء.',

    countTitle: 'ما نعدّه',
    countBody: 'نعدّ الأحداث، لا الناس: كم مرّة فُتحت صفحة، ونُزّل كتاب، ولم يجد بحثٌ شيئًا. هذه الأعداد لا تحمل أيّ هوية، ونتعمّد ألّا نعدّ الزوّار الفريدين، لأن فعل ذلك بصدق مستحيل دون تتبّعك. ولهذا أيضًا لا يوجد في هذا الموقع شريط ملفّات ارتباط: فليس هناك ما تُوافق عليه.',

    deviceTitle: 'ما يبقى على جهازك',
    deviceBody: 'مظهرك، وموضع قراءتك، وملاحظة بأنك صوّتّ سابقًا. هذه تعيش في متصفّحك كي يتذكّر الموقع تفضيلاتك؛ ولا تُرسل إلينا أبدًا.',

    thirdPartiesTitle: 'صفر أطراف ثالثة',
    thirdPartiesBody: 'لا معلنين، لا بكسلات تتبّع، لا شركات تحليلات، ولا بيع للبيانات. الخطوط تُقدَّم من موقعنا نفسه، لا من طرف ثالث.',

    controlTitle: 'كلماتك، وتحكّمك',
    controlBody: 'لأن المساهمات مجهولة بالتصميم، لا نستطيع البحث عن بياناتك، ولا يستطيع ذلك أحد سوانا: فليس ثمة ما يربطها بك. إن ندمت على شيء أرسلته، فاكتب إلينا واصفًا إياه وسنزيله.',

    formalitiesTitle: 'الرسميّات',
    formalitiesControllerLabel: 'المتحكّم في البيانات:',
    formalitiesControllerValue: 'Belief Changer (تفاصيل الجهة ستُؤكَّد قبل الإطلاق).',
    formalitiesComplaintBefore: 'إن استأت يومًا من طريقة تعاملنا مع البيانات، يمكنك التقدّم بشكوى إلى هيئة حماية البيانات الدنماركية (Datatilsynet) على',
